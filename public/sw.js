const CACHE_NAME = "paymoment-static-v2";
...
self.addEventListener("fetch", (event) => {
  ...
  // Next chunks must always be revalidated. Caching them can keep an old
  // Turbopack module graph alive after a deployment or dependency change.
