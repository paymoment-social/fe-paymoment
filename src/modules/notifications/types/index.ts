...
export type PayNotification = { id: string; type: "like" | "reply" | "follow" | "reward" | "mention" | "repost" | "message" | "system"; user?: FeedAuthor; text: string; time: string; read: boolean; href?: string; rewardAmount?: number; rewardAction?: "earned" | "redeemed"; followAction?: "requested" | "following" | "accepted" | "declined" };
