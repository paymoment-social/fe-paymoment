...
export function MessagesView() {
  ...
  if (conversations.isLoading) return <div className="grid h-full min-h-[38rem] gap-3 md:grid-cols-[17rem_1fr]" aria-label="Loading messages"><Skeleton className="h-full rounded-xl" /><Skeleton className="h-full rounded-xl" /></div>;
